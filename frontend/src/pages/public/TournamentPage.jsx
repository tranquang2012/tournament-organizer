...
const TournamentPage = () => {
  ...
  const bracketData = transformBackendMatchesToBracket(mainMatches, tournament.format, compType);
  const groups = tournament.format === 'round_robin' ? computeGroupStandings(matches, compType) : [];
