...
const mapVersusMatch = (match) => {
  ...
  return {
    ...
    team1Logo: c1 ? resolveCompetitorLogo(c1, isIndividual, logo1) : null,
    team2Logo: c2 ? resolveCompetitorLogo(c2, isIndividual, logo2) : null,
...
const SportsPage = () => {
  ...
  return (
    <div>
      ...
      <div className='relative w-full overflow-hidden bg-[#123836]'>
        <img
