        ...
        <footer className='bg-[#123836] text-white px-[5%] md:px-[10%] py-10'>
            <div className='grid grid-cols-2 md:grid-cols-4 gap-15 md:gap-53'>
                ...
                <div className='flex flex-col gap-3 items-center'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <a href='#' className='w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center hover:opacity-80'>
                            <FontAwesomeIcon icon={faFacebookF} className='text-[15px]' />
                        </a>
                        <a href='#' className='w-8 h-8 rounded-full bg-sky-500 flex items-center justify-center hover:opacity-80'>
                            <FontAwesomeIcon icon={faTwitter} className='text-[15px]' />
                        </a>
                        <a href='#' className='w-8 h-8 rounded-full bg-red-500 flex items-center justify-center hover:opacity-80'>
            ...
            <div className='mt-10 border-t border-white/10 pt-4 text-center text-[13px] text-gray-400'>
                © {new Date().getFullYear()} DTech Team. All rights reserved.
            </div>
        </footer>
    );
};
